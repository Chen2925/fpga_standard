...
/+==============================================================================*/
    ...
    assign s_SPI_ADDR_END               = ((r_SPI_BIT_CNT == 5'd8) & s_SPI_CLK_RISE)   ;
    assign s_SPI_CMD_END                = ((r_SPI_BIT_CNT == 5'd9) & s_SPI_CLK_RISE)   ;
    ...
    always @(posedge CLK or posedge RST)begin
        if(RST)begin
            r_SPI_SDO_SHFT              <= 'b0 ;
        end else if(s_SPI_RD & s_SPI_CLK_RISE) begin
