...
// =============================================================================
    ...
    wire        [  15:0]                s_REG_WR_DATA                           ;//(s)[ 32]
    wire                                s_REG_RD_REQ                            ;//(s)[  1]
    wire                                s_REG_RD_ACK                            ;//(s)[  1]
    wire        [  31:0]                s_REG_RD_DATA                           ;//(s)[ 32]
    wire        [   7:0]                s_REG_OP_ADDR                           ;//(s)[ 16]


    wire                                s_SPI_WR_REQ                            ;//(s)[  1] SPI write enable
    wire        [ 7:0]                  s_SPI_WR_ADDR                           ;//(s)[  8] SPI write addr
    wire        [15:0]                  s_SPI_WR_DATA                           ;//(s)[ 16] SPI write data
    wire                                s_SPI_WR_ACK                            ;//(s)[  1] SPI Write ack
    wire                                s_SPI_RD_REQ                            ;//(s)[  1] SPI read enable
    wire                                s_SPI_RD_ACK                            ;//(s)[  1] SPI read ack
    wire        [ 7:0]                  s_SPI_RD_ADDR                           ;//(s)[  8] SPI read addr
    wire        [15:0]                  s_SPI_RD_DATA                           ;//(s)[ 16] SPI read data
    wire                                s_SPI_OP_SEL                            ;//(s)[  1] SPI op sel
    wire                                s_SPI_OP_BUSSY                          ;//(s)[  1] SPI access busy
    wire                                s_SPI_OP_ERR                            ;//(s)[  1] SPI access busy
...
/+=============================================================================*/
    ...
    PC_SIM U_PC_SIM(
        ...
        //iic master
        .SPI_WR_REQ                     ( s_SPI_WR_REQ                  ),//(o)[  1]
        .SPI_WR_ADDR                    ( s_SPI_WR_ADDR                 ),//(o)[  8]
        .SPI_WR_DATA                    ( s_SPI_WR_DATA                 ),//(o)[ 16]
        .SPI_WR_ACK                     ( s_SPI_WR_ACK                  ),//(i)[  1]
        .SPI_RD_REQ                     ( s_SPI_RD_REQ                  ),//(o)[  1]
        .SPI_RD_ACK                     ( s_SPI_RD_ACK                  ),//(i)[  1]
        .SPI_RD_ADDR                    ( s_SPI_RD_ADDR                 ),//(i)[  8]
        .SPI_RD_DATA                    ( {16'h0000,s_SPI_RD_DATA}      ),//(i)[ 16]
        .SPI_OP_SEL                     ( s_SPI_OP_SEL                  ),//(o)[  1]
        .SPI_OP_BUSSY                   ( s_SPI_OP_BUSSY                ),//(i)[  1]
        .SPI_OP_ERR                     ( s_SPI_OP_ERR                  ) //(i)[  1]
    );
/*=============================================================================+/
||                                                                             ||
||                              SPI_SIM                                        ||
...
/+=============================================================================*/
    ...
    SPI_SIM U_SPI_SIM(
        // Global signals
        .SYS_CLK                        ( s_CLK0_P                              ),//(i) [  1]
        .SYS_RST                        ( ~s_XRST0                              ),//(i) [  1]
        // User interface
        .SPI_WR_REQ                     ( s_SPI_WR_REQ                          ),//(i) [  1]
        .SPI_WR_ADDR                    ( s_SPI_WR_ADDR                         ),//(i) [  8]
        .SPI_WR_DATA                    ( s_SPI_WR_DATA                         ),//(i) [ 16]
        .SPI_WR_ACK                     ( s_SPI_WR_ACK                          ),//(o) [  1]
        .SPI_RD_REQ                     ( s_SPI_RD_REQ                          ),//(i) [  1]
        .SPI_RD_ADDR                    ( s_SPI_RD_ADDR                         ),//(i) [  8]
        .SPI_RD_ACK                     ( s_SPI_RD_ACK                          ),//(o) [ 16]
        .SPI_RD_DATA                    ( s_SPI_RD_DATA                         ),//(o) [  1]
        .SPI_OP_SEL                     ( s_SPI_OP_SEL                          ),//(i) [  1]
        .SPI_OP_BUSY                    ( s_SPI_OP_BUSSY                        ),//(o) [  1]
        .SPI_OP_ERR                     ( s_SPI_OP_ERR                          ),//(o) [  1]
        // SPI interface
        .REG_WR_REQ                     ( s_REG_WR_REQ                          ),//(o) [  1]
        .REG_RD_REQ                     ( s_REG_RD_REQ                          ),//(o) [  1]
        .REG_RD_ACK                     ( s_REG_RD_ACK                          ),//(o) [  1]
        .REG_WR_DATA                    ( s_REG_WR_DATA                         ),//(o) [  1]
        .REG_RD_DATA                    ( s_REG_RD_DATA[15:0]                   ),//(i) [  1]
        .REG_OP_ADDR                    ( s_REG_OP_ADDR                         ) //(o) [  1]
    ) ;
...
/+=============================================================================*/
    ...
    REG_BIST U_REG_BIST(
        ...
        .REG_RD_ACK                     ( s_REG_RD_ACK                  ),//(o)  [   1]
        .REG_WR_DATA                    ( {16'h0000,s_REG_WR_DATA}      ),//(i)  [  32]
        .REG_RD_DATA                    ( s_REG_RD_DATA                 ),//(o)  [  32]
        .REG_OP_ADDR                    ( {8'h00,s_REG_OP_ADDR}         ),//(i)  [  16]
