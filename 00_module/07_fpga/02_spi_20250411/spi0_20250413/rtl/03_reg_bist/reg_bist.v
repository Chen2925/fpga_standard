...
// =============================================================================
    ...
    parameter   p_ADD_FPGA_VER0         = 32'h000                               ;//(p)  [ 10]
    parameter   p_ADD_FPGA_VER1         = 32'h001                               ;//(p)  [ 10]
    parameter   p_ADD_FPGA_VER2         = 32'h002                               ;//(p)  [ 10]
    parameter   p_ADD_FPGA_VER3         = 32'h003                               ;//(p)  [ 10]
    parameter   p_ADD_BORD_VER0         = 32'h004                               ;//(p)  [ 10]
    parameter   p_ADD_BORD_VER1         = 32'h005                               ;//(p)  [ 10]

    parameter   p_ADD_DEBUG_DI0         = 32'h010                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DI1         = 32'h011                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DI2         = 32'h012                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DI3         = 32'h013                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DI4         = 32'h014                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DI5         = 32'h015                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DI6         = 32'h016                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DI7         = 32'h017                               ;//(p)  [ 10]

    parameter   p_ADD_DEBUG_DO0         = 32'h020                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DO1         = 32'h021                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DO2         = 32'h022                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DO3         = 32'h023                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DO4         = 32'h024                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DO5         = 32'h025                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DO6         = 32'h026                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_DO7         = 32'h027                               ;//(p)  [ 10]

    parameter   p_ADD_DEBUG_TRIG0       = 32'h030                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_TRIG1       = 32'h031                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_TRIG2       = 32'h032                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_TRIG3       = 32'h033                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_TRIG4       = 32'h034                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_TRIG5       = 32'h035                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_TRIG6       = 32'h036                               ;//(p)  [ 10]
    parameter   p_ADD_DEBUG_TRIG7       = 32'h037                               ;//(p)  [ 10]

// =============================================================================
// Internal signal define
// =============================================================================

(*KEEP="TRUE",mark_debug="true"*)    reg                                 r_REG_WEN                               ;//(r)  [  1]
(*KEEP="TRUE",mark_debug="true"*)    reg                                 r_REG_REN                               ;//(r)  [  1]
    reg         [  31:0]                r_REG_WDT                               ;//(r)  [ 32]
    reg         [  31:0]                r_REG_ADR                               ;//(r)  [ 10]

(*KEEP="TRUE",mark_debug="true"*)    reg                                 r_REG_WR_ACK                            ;//(r)  [  1]
(*KEEP="TRUE",mark_debug="true"*)    reg                                 r_REG_RD_ACK                            ;//(r)  [  5]
