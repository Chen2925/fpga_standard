...
// =============================================================================
    ...
    //UART IF
    wire                                s_UART_RX_ERR                           ;//(s)[  1]
    wire                                s_UART_RX_DVLD                          ;//(s)[  1]
    wire        [   7:0]                s_UART_RX_DATA                          ;//(s)[  8]
    wire                                s_UART_TX_REQ                           ;//(s)[  1]
    wire                                s_UART_TX_ACK                           ;//(s)[  1]
    wire        [   7:0]                s_UART_TX_DATA                           ;//(s)[  8]
...
/+=============================================================================*/
    ...
    PC_SIM U_PC_SIM (
        ...
        .REG_WR_REQ                     ( s_REG0_WR_REQ                 ),//(o)  [  1]  Register write request
        .REG_WR_ACK                     ( s_REG0_WR_ACK                 ),//(i)  [  1]  Register write acknowledge
        .REG_WR_DATA                    ( s_REG0_WR_DATA                ),//(o)  [ 32]  Register write data
        .REG_RD_REQ                     ( s_REG0_RD_REQ                 ),//(o)  [  1]  Register read request
        .REG_RD_ACK                     ( s_REG0_RD_ACK                 ),//(i)  [  1]  Register read acknowledge
        .REG_RD_DATA                    ( s_REG0_RD_DATA                ),//(i)  [ 32]  Register read data
        .REG_OP_ADDR                    ( s_REG0_OP_ADDR                ),//(o)  [ 10]  Register operation address

        .UART_RX_ERR                    ( s_UART_RX_ERR                 ),//(i)[   1]
        .UART_RX_DVLD                   ( s_UART_RX_DVLD                ),//(i)[   1]
        .UART_RX_DATA                   ( s_UART_RX_DATA                ),//(i)[   8]
        .UART_TX_REQ                    ( s_UART_TX_REQ                 ),//(o)[   1]
        .UART_TX_ACK                    ( s_UART_TX_ACK                 ),//(i)[   1]
        .UART_TX_DATA                   ( s_UART_TX_DATA                ) //(o)[   8]
    );
