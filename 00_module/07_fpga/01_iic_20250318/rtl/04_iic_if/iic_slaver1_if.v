// =================================================================================================
// File Name        : I2C_SLAVE1_IF.v
// Module           : I2C_SLAVE1_IF
// Function         : I2C_SLAVE1_IF
// Type             : RTL
// -------------------------------------------------------------------------------------------------
// Update History :
// -------------------------------------------------------------------------------------------------
...
/+=============================================================================*/
    ...
    always @(posedge CLK or posedge RST) begin
        if (RST) begin
            ...
            if( (r_FSM_I2C_WACK)) begin
                if( ~r_I2C_SLV_ADDR[0] & s_SCL_NEG & (r_I2C_SLV_ADDR[7:1] == 7'h01)) begin
                    r_I2C_WR_EN         <= 1'b1                                 ;
                end else begin
                    r_I2C_WR_EN         <= 1'b0                                 ;
                end
    ...
    always @(posedge CLK or posedge RST) begin
        if (RST) begin
            ...
            if(r_I2C_SLV_ADDR[0] & s_SCL_NEG & r_FSM_I2C_SLACK & (r_I2C_SLV_ADDR[7:1] == 7'h01)) begin
                r_I2C_RD_EN                 <= 1'b1                             ;
            end else begin
                r_I2C_RD_EN                 <= 1'b0                             ;
            end
