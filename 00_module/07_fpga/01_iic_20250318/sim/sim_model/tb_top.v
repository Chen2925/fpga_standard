...
// =============================================================================
    ...
    //iic if
    wire                                s_I2C_WR_EN                             ;//(s)[  1]
    wire        [   7:0]                s_I2C_WR_DATA                           ;//(s)[  8]
    wire                                s_I2C_WR_ACK                            ;//(s)[  1]
    wire                                s_I2C_RD_EN                             ;//(s)[  1]
    wire                                s_I2C_RD_ACK                            ;//(s)[  1]
    wire        [   7:0]                s_I2C_RD_DATA                           ;//(s)[  8]
    wire        [   7:0]                s_I2C_SLV_ADDR                          ;//(s)[  8]
    wire        [   7:0]                s_I2C_SUB_ADDR                          ;//(s)[  8]
    wire                                s_I2C_ACK_ERR                           ;//(s)[  1]
    wire                                s_I2C_BUSY                              ;//(s)[  1]

    wire                                s_I2C_SLAV0_WR_EN                       ;//(s)[  1]
    wire        [   7:0]                s_I2C_SLAV0_WR_DATA                     ;//(s)[  8]
    wire        [   7:0]                s_I2C_SLAV0_OP_ADDR                     ;//(s)[  8]
    wire                                s_I2C_SLAV0_RD_EN                       ;//(s)[  1]
    wire        [   7:0]                s_I2C_SLAV0_RD_DATA                     ;//(s)[  8]
    wire                                s_I2C_SLAV0_RD_ACK                      ;//(s)[  1]

    wire                                s_I2C_SLAV1_WR_EN                       ;//(s)[  1]
    wire        [   7:0]                s_I2C_SLAV1_WR_DATA                     ;//(s)[  8]
    wire        [   7:0]                s_I2C_SLAV1_OP_ADDR                     ;//(s)[  8]
    wire                                s_I2C_SLAV1_RD_EN                       ;//(s)[  1]
    wire        [   7:0]                s_I2C_SLAV1_RD_DATA                     ;//(s)[  8]
    wire                                s_I2C_SLAV1_RD_ACK                      ;//(s)[  1]
...
/+=============================================================================*/
    ...
    PC_SIM U_PC_SIM(
        .CLK                            ( s_CLK0_P                      ),//(i)[1] System clock  200M
        .RST                            ( ~s_XRST0                      ),//(i)[1] System reset
        //sim model
        .REG_WR_REQ                     ( s_REG0_WR_REQ                 ),//(i)[  1]
        .REG_WR_ACK                     ( s_REG0_WR_ACK                 ),//(o)[  1]
        .REG_WR_DATA                    ( s_REG0_WR_DATA                ),//(i)[ 32]
        .REG_RD_REQ                     ( s_REG0_RD_REQ                 ),//(i)[  1]
        .REG_RD_ACK                     ( s_REG0_RD_ACK                 ),//(o)[  1]
        .REG_RD_DATA                    ( s_REG0_RD_DATA                ),//(o)[ 32]
        .REG_OP_ADDR                    ( s_REG0_OP_ADDR                ),//(i)[ 10]

        //iic master
        .I2C_WR_EN                      ( s_I2C_WR_EN                   ),//(o)[  1] I2C write enable
        .I2C_WR_DATA                    ( s_I2C_WR_DATA                 ),//(o)[  8] I2C write data
        .I2C_WR_ACK                     ( s_I2C_WR_ACK                  ),//(i)[  1] I2C Write ack
        .I2C_RD_EN                      ( s_I2C_RD_EN                   ),//(o)[  1] I2C read enable
        .I2C_RD_ACK                     ( s_I2C_RD_ACK                  ),//(i)[  1] I2C read ack
        .I2C_RD_DATA                    ( s_I2C_RD_DATA                 ),//(i)[  8] I2C read data

        .I2C_SLV_ADDR                   ( s_I2C_SLV_ADDR                ),//(o)[  8] I2C slaver address
        .I2C_SUB_ADDR                   ( s_I2C_SUB_ADDR                ),//(o)[  8] I2C sub address
        .I2C_ACK_ERR                    ( s_I2C_ACK_ERR                 ),//(i)[  1] I2C access error
        .I2C_BUSY                       ( s_I2C_BUSY                    ) //(i)[  1] I2C access busy
    );
...
/+=============================================================================*/
    ...
    I2C_TOP_SIM U_I2C_TOP_SIM(
        .CLK                            ( s_CLK0_P                      ),//(i)[1] System clock  200M
        .RST                            ( ~s_XRST0                      ),//(i)[1] System reset
        // I2C master
        .I2C_WR_EN                      ( s_I2C_WR_EN                   ),//(i)[  1] I2C write enable
        .I2C_WR_DATA                    ( s_I2C_WR_DATA                 ),//(i)[  8] I2C write data
        .I2C_WR_ACK                     ( s_I2C_WR_ACK                  ),//(o)[  1] I2C Write ack
        .I2C_RD_EN                      ( s_I2C_RD_EN                   ),//(i)[  1] I2C read enable
        .I2C_RD_ACK                     ( s_I2C_RD_ACK                  ),//(o)[  1] I2C read ack
        .I2C_RD_DATA                    ( s_I2C_RD_DATA                 ),//(o)[  8] I2C read data
        .I2C_SLV_ADDR                   ( s_I2C_SLV_ADDR                ),//(i)[  8] I2C slaver address
        .I2C_SUB_ADDR                   ( s_I2C_SUB_ADDR                ),//(i)[  8] I2C sub address
        .I2C_ACK_ERR                    ( s_I2C_ACK_ERR                 ),//(o)[  1] I2C access error
        .I2C_BUSY                       ( s_I2C_BUSY                    ),//(o)[  1] I2C access busy
        // I2C slaver0
        .I2C_SLAV0_WR_EN                ( s_I2C_SLAV0_WR_EN             ),//(o)[  1] I2C slaver0 write enable
        .I2C_SLAV0_WR_DATA              ( s_I2C_SLAV0_WR_DATA           ),//(o)[  8] I2C slaver0 write data
        .I2C_SLAV0_OP_ADDR              ( s_I2C_SLAV0_OP_ADDR           ),//(o)[  8] I2C slaver0 write address
        .I2C_SLAV0_RD_EN                ( s_I2C_SLAV0_RD_EN             ),//(o)[  1] I2C slaver0 read  enable
        .I2C_SLAV0_RD_DATA              ( s_I2C_SLAV0_RD_DATA           ),//(o)[  8] I2C slaver0 read  data
        .I2C_SLAV0_RD_ACK               ( s_I2C_SLAV0_RD_ACK            ),//(o)[  1] I2C slaver0 read  data ACK
        // I2C slaver0
        .I2C_SLAV1_WR_EN                ( s_I2C_SLAV1_WR_EN             ),//(o)[  1] I2C slaver1 write enable
        .I2C_SLAV1_WR_DATA              ( s_I2C_SLAV1_WR_DATA           ),//(o)[  8] I2C slaver1 write data
        .I2C_SLAV1_OP_ADDR              ( s_I2C_SLAV1_OP_ADDR           ),//(o)[  8] I2C slaver1 write address
        .I2C_SLAV1_RD_EN                ( s_I2C_SLAV1_RD_EN             ),//(o)[  1] I2C slaver1 read  enable
        .I2C_SLAV1_RD_DATA              ( s_I2C_SLAV1_RD_DATA           ),//(o)[  8] I2C slaver1 read  data
        .I2C_SLAV1_RD_ACK               ( s_I2C_SLAV1_RD_ACK            ) //(o)[  1] I2C slaver1 read  data ACK
    );
...
/+=============================================================================*/
    ...
    REG_IF U_REG_IF(
        ...
        .RST                            ( ~s_XRST0                      ),//(i)  [   1]
        //iic slaver0
        .I2C_SLAV0_WR_EN                ( s_I2C_SLAV0_WR_EN             ),//(i)[  1] I2C slaver0 write enable
        .I2C_SLAV0_WR_DATA              ( s_I2C_SLAV0_WR_DATA           ),//(i)[  8] I2C slaver0 write data
        .I2C_SLAV0_OP_ADDR              ( s_I2C_SLAV0_OP_ADDR           ),//(i)[  8] I2C slaver0 write address
        .I2C_SLAV0_RD_EN                ( s_I2C_SLAV0_RD_EN             ),//(i)[  1] I2C slaver0 read  enable
        .I2C_SLAV0_RD_DATA              ( s_I2C_SLAV0_RD_DATA           ),//(o)[  8] I2C slaver0 read  data
        .I2C_SLAV0_RD_ACK               ( s_I2C_SLAV0_RD_ACK            ),//(o)[  1] I2C slaver0 read  data ACK
        //iic slaver1
        .I2C_SLAV1_WR_EN                ( s_I2C_SLAV1_WR_EN             ),//(i)[  1] I2C slaver1 write enable
        .I2C_SLAV1_WR_DATA              ( s_I2C_SLAV1_WR_DATA           ),//(i)[  8] I2C slaver1 write data
        .I2C_SLAV1_OP_ADDR              ( s_I2C_SLAV1_OP_ADDR           ),//(i)[  8] I2C slaver1 write address
        .I2C_SLAV1_RD_EN                ( s_I2C_SLAV1_RD_EN             ),//(i)[  1] I2C slaver1 read  enable
        .I2C_SLAV1_RD_DATA              ( s_I2C_SLAV1_RD_DATA           ),//(o)[  8] I2C slaver1 read  data
        .I2C_SLAV1_RD_ACK               ( s_I2C_SLAV1_RD_ACK            ),//(o)[  1] I2C slaver1 read  data ACK
        //reg bist
        .REG_WR_REQ                     ( s_REG_WR_REQ                  ),//(o)  [  1]  Register write request
        .REG_WR_ACK                     ( s_REG_WR_ACK                  ),//(i)  [  1]  Register write acknowledge
        .REG_WR_DATA                    ( s_REG_WR_DATA                 ),//(o)  [ 32]  Register write data
        .REG_RD_REQ                     ( s_REG_RD_REQ                  ),//(o)  [  1]  Register read request
        .REG_RD_ACK                     ( s_REG_RD_ACK                  ),//(i)  [  1]  Register read acknowledge
        .REG_RD_DATA                    ( s_REG_RD_DATA                 ),//(i)  [ 32]  Register read data
        .REG_OP_ADDR                    ( s_REG_OP_ADDR                 ) //(o)  [ 10]  Register operation address
    );
